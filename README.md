...
<table>
  <tr>
    <td width="25%" valign="top">
      ...
      <sub>Homelab setup, services, scripts and infrastructure notes.</sub>
    </td>
    <td width="25%" valign="top">
      <a href="https://github.com/PricelessToolkit/HA-Add-ons"><strong>HA-Add-ons</strong></a><br />
      <sub>Home Assistant add-ons.</sub>
    </td>
    <td width="25%" valign="top">
    ...
    <td width="25%" valign="top">
      <a href="https://github.com/PricelessToolkit/UNIProg_Programmer/tree/main"><strong>UNIProg_Programmer</strong></a><br />
      <sub>Universal UPDI and UART programmer.</sub>
    </td>
  </tr>
</table>
